 ...
 */
public class DashBoardQuranFragmentAdapter extends RecyclerView.Adapter<DashBoardQuranFragmentAdapter.ViewHolder> {

    private final List<DashBoardDuaItem> mValues;
    private final ItemClickListener mListener;

    public DashBoardQuranFragmentAdapter(List<DashBoardDuaItem> items, ItemClickListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dashboard_quran_activity_adapter, parent, false);
...
//        holder.mNoOfChapters.setVisibility(View.GONE);
//        holder.mNoOfChapters.setText(mValues.get(position).getNoOfChapter()+" Chapters");
        holder.mTvIcon.setImageResource(R.drawable.kuran_48);
