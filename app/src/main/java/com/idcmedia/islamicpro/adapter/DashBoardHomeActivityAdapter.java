 ...
 */
public class DashBoardHomeActivityAdapter extends RecyclerView.Adapter<DashBoardHomeActivityAdapter.ViewHolder> {

    private final List<DashBoardData> mValues;
    private final ItemClickListener mListener;

    public DashBoardHomeActivityAdapter(List<DashBoardData> items, ItemClickListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dashboard_home_activity_adapter, parent, false);
