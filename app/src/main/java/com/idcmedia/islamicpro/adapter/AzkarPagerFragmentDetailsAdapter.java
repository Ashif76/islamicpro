...
import com.idcmedia.islamicpro.fragment.AzkarPagerFragmentDetails;
 ...
 */
public class AzkarPagerFragmentDetailsAdapter extends RecyclerView.Adapter<AzkarPagerFragmentDetailsAdapter.ViewHolder> {

    private final List<DuaStubs> mValues;
    private final OnListFragmentInteractionListener mListener;

    public AzkarPagerFragmentDetailsAdapter(List<DuaStubs> items, AzkarPagerFragmentDetails listener) {
        mValues = items;
        mListener = listener;
    }
